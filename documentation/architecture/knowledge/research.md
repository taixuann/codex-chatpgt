...
It extends `documentation/architecture/workflow/operation.md`. Projects inherit this workflow and add only domain-specific context, validation, required comparison dimensions, and genuinely different lifecycle steps.
