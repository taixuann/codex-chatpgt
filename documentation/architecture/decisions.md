...
`documentation/architecture/workflow/operation.md` is the canonical human-readable
...
`documentation/architecture/workflow/operation.md` governs any future machine workflow
...
Issue/PLAN and `architecture/workflow/operation.md` remain semantic authority; the catalog
...
`documentation/architecture/agents.md` provide the repository's portable semantic
