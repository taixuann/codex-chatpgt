...
axis, and round. Keep the seven-character head prefix only as a display label. Use
`review_receipt_filename()` for
`athena-<candidate-sha>-<axis>-r<round>-<attempt-id>.yaml`; refuse an existing path rather than
