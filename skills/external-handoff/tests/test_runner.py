...
class NonInteractiveRunnerTests(unittest.TestCase):
    ...
    def test_repository_root_is_verified(self):
        ...
        self.assertTrue((root / "manifests" / "agent-capability-repertoires.yaml").is_file())
    ...
    def test_copied_marker_git_root_with_canonical_origin_is_rejected(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            for relative in ("AGENTS.md", "agents/AGENTS.md", "skills/AGENTS.md", "documentation/OPERATING-WORKFLOW.md", "ops/schemas/franky-task.schema.yaml", "ops/schemas/franky-result.schema.yaml", "manifests/agent-capability-repertoires.yaml"):
