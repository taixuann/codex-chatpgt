...
Execute tasks one at a time following `skills/code/incremental-implementation/SKILL.md` (`incremental-implementation`) and `skills/code/test-driven-development/SKILL.md` (`test-driven-development`). Use `skills/code/context-engineering/SKILL.md` (`context-engineering`) to load the right spec sections and source files at each step rather than flooding the agent with the entire spec.
