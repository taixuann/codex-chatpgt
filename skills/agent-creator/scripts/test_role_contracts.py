...
class RoleContractTests(unittest.TestCase):
    def test_standalone_shape_and_sandbox(self):
        ...
        self.assertEqual(roles["athena"]["model"], "gpt-6-luna")
        self.assertEqual(roles["athena"]["model_reasoning_effort"], "max")
        self.assertIn("GPT-6 Luna Max", roles["athena"]["developer_instructions"])
        self.assertEqual(roles["athena"]["mcp_servers"]["exa"]["url"], "https://mcp.exa.ai/mcp")
