...
ALLOWED_PREFIXES = ("agents/", "documentation/", "skills/franky-", "skills/project-bootstrap/", "skills/external-handoff/", "skills/install-project-link/", "skills/shared-session-closeout/", ".github/", "manifests/", "ops/schemas/", "ops/scripts/", "ops/schedulers/", "ops/changes/")
