...
This repository copy omits `agents/openai.yaml` because no current runtime
consumer has been demonstrated. Do not add an adapter or claim implicit
loading without revision-bound runtime evidence.
