...
FIXTURE = ROOT / "skills" / "control-plane" / "control-plane-audit" / "scripts" / "fixtures" / "skill-routing.yaml"
MODULE_PATH = ROOT / "skills" / "control-plane" / "control-plane-audit" / "scripts" / "validate_skill_routing.py"
